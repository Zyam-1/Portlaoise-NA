...
Begin VB.Form frmViewEndRepeat 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "NetAcquire - Endcrinology Repeats"
   ClientHeight    =   5685
   ClientLeft      =   4770
   ClientTop       =   2475
   ClientWidth     =   5175
   Icon            =   "frmViewEndRepeat.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5685
   ...
   Begin VB.CommandButton bCancel 
      ...
      Height          =   765
      Left            =   3645
      Picture         =   "frmViewEndRepeat.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   4665
      Width           =   1215
   ...
   Begin VB.CommandButton bTransfer 
      ...
      Height          =   855
      Left            =   3645
      Picture         =   "frmViewEndRepeat.frx":0614
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   495
      Visible         =   0   'False
   ...
   Begin VB.CommandButton bDelete 
      ...
      Height          =   945
      Left            =   3645
      Picture         =   "frmViewEndRepeat.frx":091E
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   1785
      Width           =   1215
   ...
   End
End
Attribute VB_Name = "frmViewEndRepeat"
...
20        If frmEditAll.cCat(0) = "" Then Cat = "Default" Else Cat = frmEditAll.cCat(0)

30        Set IRs = IRs.Load("End", frmEditAll.txtSampleID, "Repeats", gDONTCARE, gDONTCARE, 0, Cat, frmEditAll.dtRunDate)
...
280       LogError "frmViewEndRepeat", "FillG", intEL, strES
...
30            sql = "DELETE from EndRepeats WHERE " & _
                    "SampleID = '" & frmEditAll.txtSampleID & "'"

40            Cnxn(0).Execute sql

50            frmEditAll.LoadEndocrinology
60            Unload Me
...
110       LogError "frmViewEndRepeat", "bDELETE_Click", intEL, strES, sql
...
60                Code = eCodeForShortName(g)
70                sqlFrom = "SELECT * from EndRepeats WHERE " & _
                            "SampleID = '" & frmEditAll.txtSampleID & "' " & _
                            "and Code = '" & Code & "'"
80                sqlTo = "SELECT * from EndResults WHERE " & _
                          "SampleID = '" & frmEditAll.txtSampleID & "' " & _
                          "and Code = '" & Code & "'"
...
180               Next
190               tbTo.Update
200               sql = "delete from endrepeats where sampleid = '" & frmEditAll.txtSampleID & "' and code = '" & Code & "' and result = '" & tbFrom!Result & "'"
210               Cnxn(0).Execute sql
220           End If
230       Next

240       frmEditAll.LoadEndocrinology
250       Unload Me
...
290       LogError "frmViewEndRepeat", "bTransfer_Click", intEL, strES, sqlFrom
...
80        LogError "frmViewEndRepeat", "Form_Activate", intEL, strES
...
60        LogError "frmViewEndRepeat", "Form_Load", intEL, strES
...
40        intEL = Erl
50        strES = Err.Description
60        LogError "frmViewEndRepeat", "Form_Unload", intEL, strES
...
220       LogError "frmViewEndRepeat", "g_Click", intEL, strES
