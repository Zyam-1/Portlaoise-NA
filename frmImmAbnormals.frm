...
Begin VB.Form frmImmAbnormals 
   Caption         =   "NetAcquire - Immunology Abnormals"
   ClientHeight    =   6135
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9060
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton bRecalc 
         ...
         Height          =   720
         Left            =   3330
         Picture         =   "frmImmAbnormals.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   360
         Width           =   1455
      ...
      Begin Threed.SSRibbon b 
         ...
         Value           =   -1  'True
         PictureDnChange =   2
         PictureUp       =   "frmImmAbnormals.frx":0614
      End
      Begin Threed.SSRibbon b 
         Height          =   285
         Index           =   4
         ...
         PictureUp       =   "frmImmAbnormals.frx":0BD2
      End
      Begin Threed.SSRibbon b 
         Height          =   285
         Index           =   3
         ...
         BackColor       =   12632256
         GroupAllowAllUp =   -1  'True
         PictureUp       =   "frmImmAbnormals.frx":1204
      End
      Begin Threed.SSRibbon b 
         Height          =   285
         Index           =   2
         ...
         BackColor       =   12632256
         GroupAllowAllUp =   -1  'True
         PictureUp       =   "frmImmAbnormals.frx":17C2
      End
      Begin Threed.SSRibbon b 
         Height          =   285
         Index           =   1
         ...
         BackColor       =   12632256
         GroupAllowAllUp =   -1  'True
         PictureUp       =   "frmImmAbnormals.frx":1D80
      End
      Begin Threed.SSRibbon b 
         Height          =   285
         Index           =   0
         ...
         BackColor       =   12632256
         GroupAllowAllUp =   -1  'True
         PictureUp       =   "frmImmAbnormals.frx":23B2
      End
   ...
   Begin VB.CommandButton bCancel 
      ...
      Height          =   795
      Left            =   7470
      Picture         =   "frmImmAbnormals.frx":2970
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   5040
      Width           =   1335
   ...
   Begin VB.CommandButton bPrintList 
      ...
      Height          =   795
      Left            =   4095
      Picture         =   "frmImmAbnormals.frx":2C7A
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   5040
      Width           =   1245
   ...
   Begin VB.CommandButton bPrintReports 
      ...
      Height          =   795
      Left            =   5715
      Picture         =   "frmImmAbnormals.frx":2F84
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   5040
      Width           =   1380
   ...
   End
End
Attribute VB_Name = "frmImmAbnormals"
...
180       LogError "frmImmAbnormals", "b_Click", intEL, strES
...
100       For n = 0 To g.Rows - 1
110           Printer.Print g.TextMatrix(n, 0);
120           Printer.Print Tab(15); g.TextMatrix(n, 1);
130           Printer.Print Tab(35); g.TextMatrix(n, 2)
140       Next
...
190       LogError "frmImmAbnormals", "bPrintList_Click", intEL, strES
...
160       LogError "frmImmAbnormals", "bPrintReports_Click", intEL, strES
...
60        LogError "frmImmAbnormals", "brecalc_Click", intEL, strES
...
390       LogError "frmImmAbnormals", "CalcOutsideRange", intEL, strES
...
40        intEL = Erl
50        strES = Err.Description
60        LogError "frmImmAbnormals", "calFrom_Click", intEL, strES
...
40        intEL = Erl
50        strES = Err.Description
60        LogError "frmImmAbnormals", "calTo_Click", intEL, strES
...
50        sql = "SELECT * from ImmTestDefinitions WHERE longname = '" & lAnalyte & "'"
...
160       sql = "SELECT * from ImmResults WHERE " & _
                "(runtime between '" & _
...
250           sql = "SELECT count(sampleid) as tot from ImmResults WHERE " & _
                    "(runtime between '" & _
                    Format(calFrom, "dd/mmm/yyyy") & " 00:00:00' and '" & _
                    Format(calTo, "dd/mmm/yyyy") & " 23:59:59') " & _
                    "and code = '" & TestNumber & _
...
550       LogError "frmImmAbnormals", "FillG", intEL, strES, sql
...
60        sql = "SELECT distinct(longname) from ImmTestDefinitions WHERE inuse = 1"
...
140       intEL = Erl
150       strES = Err.Description
160       LogError "frmImmAbnormals", "Form_Load", intEL, strES, sql
...
150       LogError "frmImmAbnormals", "g_Click", intEL, strES, sql
...
20        sql = "SELECT * from ImmTestDefinitions WHERE longname = '" & lAnalyte & "'"
...
290       LogError "frmImmAbnormals", "lAnalyte_Click", intEL, strES, sql
...
100       LogError "frmImmAbnormals", "o_Click", intEL, strES
...
130       intEL = Erl
140       strES = Err.Description
150       LogError "frmImmAbnormals", "RemoveNormals", intEL, strES
