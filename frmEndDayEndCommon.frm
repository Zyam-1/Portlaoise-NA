...
Begin VB.Form frmEndDayEndCommon 
   Caption         =   "NetAcquire 6 - Endocrinology End of Day Report (Common Parameters)"
   ClientHeight    =   8430
   ClientLeft      =   90
   ClientTop       =   420
   ClientWidth     =   11520
   Icon            =   "frmEndDayEndCommon.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8430
   ...
   Begin VB.CommandButton cmdStart 
      ...
      Height          =   960
      Left            =   3120
      Picture         =   "frmEndDayEndCommon.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   45
      Visible         =   0   'False
   ...
   Begin VB.CommandButton bcancel 
      ...
      Height          =   960
      Left            =   9630
      Picture         =   "frmEndDayEndCommon.frx":0614
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   45
      Width           =   1245
   ...
   Begin VB.CommandButton bprint 
      ...
      Height          =   960
      Left            =   8325
      Picture         =   "frmEndDayEndCommon.frx":091E
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   45
      Width           =   1245
   ...
   Begin VB.CommandButton breport 
      ...
      Height          =   960
      Left            =   4410
      Picture         =   "frmEndDayEndCommon.frx":0C28
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   45
      Visible         =   0   'False
   ...
   Begin VB.CommandButton bBlockPrint 
      ...
      Height          =   960
      Left            =   7020
      Picture         =   "frmEndDayEndCommon.frx":0F32
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   45
      Width           =   1245
   ...
   Begin VB.CommandButton bBlockValidate 
      ...
      Height          =   960
      Left            =   5715
      Picture         =   "frmEndDayEndCommon.frx":123C
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   45
      Width           =   1245
   ...
   Begin MSFlexGridLib.MSFlexGrid g 
      ...
      GridLinesFixed  =   3
      AllowUserResizing=   1
      FormatString    =   $"frmEndDayEndCommon.frx":1546
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmEndDayEndCommon"
...
190       LogError "frmEndDayEndCommon", "bBlockPrint_Click", intEL, strES
...
170       intEL = Erl
180       strES = Err.Description
190       LogError "frmEndDayEndCommon", "bBlockValidate_Click", intEL, strES, sql
...
60        Printer.Print "Endocrinology end of day report for " & Format(dtRunDate, "dd/mmm/yyyy")

70        For Y = 0 To g.Rows - 1
80            pb = Y
90            Printer.Print g.TextMatrix(Y, 0);    'RunNumber
100           Printer.Print Tab(10); g.TextMatrix(Y, 1);    'Name
110           Printer.Print Tab(30); g.TextMatrix(Y, 2);    'DoB
120           If Y = 0 Then
130               Printer.Print Tab(41); "Ward";
140           Else
150               sql = "SELECT * from wards WHERE text = '" & Trim(UCase(g.TextMatrix(Y, 3))) & "' or code = '" & Trim(UCase(g.TextMatrix(Y, 3))) & "'"
160               Set sn = New Recordset
170               RecOpenServer 0, sn, sql
180               If Not sn.EOF Then
190                   Printer.Print Tab(41); Left(sn!Code & "      ", 6);
200               End If
210           End If
220           If Y = 0 Then
230               Printer.Print Tab(48); "Clin";
240           Else
250               sql = "SELECT * from gps WHERE text =  '" & Trim(UCase(g.TextMatrix(Y, 4))) & "'"
260               Set sn = New Recordset
270               RecOpenServer 0, sn, sql
280               If Not sn.EOF Then
290                   Printer.Print Tab(48); Left(sn!Code & "      ", 6);
300               End If
310           End If
320           Printer.Print Tab(54);
330           For X = 5 To g.Cols - 1
340               Printer.Print Left(g.TextMatrix(Y, X) & "     ", 5);
350           Next
360           Printer.Print
370       Next
...
60        LogError "frmEndDayEndCommon", "dtRunDate_CloseUp", intEL, strES
...
60        sql = "SELECT distinct shortname, code from Endtestdefinitions WHERE eod = '1'"
70        Set tb = New Recordset
80        RecOpenServer 0, tb, sql
90        Do While Not tb.EOF
100           tsql = tsql & "EndResults.code = '" & Trim(tb!Code) & "' or "
...
300       sql = "SELECT * from demographics, Endresults  WHERE " & _
                "demographics.sampleid = EndResults.sampleid " & _
                "and ( EndResults.rundate =  '" & Format(dtRunDate, "dd/mmm/yyyy") & "') and (" & tsql & _
                ") order by EndResults.sampleid"
...
460               strin = EndShortNameFor(!Code & "")
...
600       LogError "frmEndDayEndCommon", "FillG", intEL, strES, sql
...
80        LogError "frmEndDayEndCommon", "Form_Load", intEL, strES
...
240       LogError "frmEndDayEndCommon", "g_Click", intEL, strES
