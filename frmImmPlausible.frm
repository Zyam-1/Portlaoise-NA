...
Begin VB.Form frmImmPlausible 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "NetAcquire - Immunology Plausible Ranges"
   ClientHeight    =   7155
   ClientLeft      =   1245
   ClientTop       =   1005
   ClientWidth     =   5415
   Icon            =   "frmImmPlausible.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7155
   ...
   Begin VB.CommandButton bcancel 
      ...
      Height          =   675
      Left            =   4230
      Picture         =   "frmImmPlausible.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   6165
      Width           =   1035
   ...
   Begin VB.CommandButton bPrint 
      ...
      Height          =   675
      Left            =   4275
      Picture         =   "frmImmPlausible.frx":0614
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   135
      Width           =   1035
   ...
   End
End
Attribute VB_Name = "frmImmPlausible"
...
250       LogError "frmImmPlausible", "FillG", intEL, strES, sql
...
80        LogError "frmImmPlausible", "SaveG", intEL, strES, sql
...
200       LogError "frmImmPlausible", "bPrint_Click", intEL, strES
...
60        intEL = Erl
70        strES = Err.Description
80        LogError "frmImmPlausible", "Form_Load", intEL, strES
...
270       LogError "frmImmPlausible", "g_Click", intEL, strES
